<%-- 
    Document   : home.jsp
    Created on : Mar 1, 2023, 10:52:15 PM
    Author     : Admin
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <br>
            <br>
            <h1 style="color: white; font-family: 'Dosis', sans-serif;">Phim Thịnh Hành</h1>
                        ...
                        <c:choose>
                            <c:when test="${count.index eq 0}">
                                <div class="carousel-item active">
                                    <img src="img/${item.getImageTimeLine()}"
            ...
            <div class = 'search-box d-flex justify-content-between'>
                <h2 style="color: white; font-family: 'Dosis', sans-serif;">Chọn Phim</h2>
                ...
                <c:forEach items="${data}" var="item">
                    <div class="card movie-item" style="width:300px">
                        <img class="card-img-top img-movie"
                             src="img/${item.getImage()}"
                             alt="Card image" style="width:100%">
                        <div class="card-body">
                            <h4 class="card-title">${item.getTen()}</h4>
                            <p class="card-text">${item.getTomTat()}</p>
                            <a href="detail?movieId=${item.getPhimId()}" class="btn btn-outline-warning"
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <a href="/AssignmentVer1/branches?movieId=${item.getPhimId()}" class="btn btn-outline-danger">Mua vé</a>
                                </c:otherwise>
                            </c:choose>
                        </div>
                    </div>
